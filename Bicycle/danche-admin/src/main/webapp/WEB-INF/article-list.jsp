...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 订单管理 <span class="c-gray en">&gt;</span> 用户订单 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
		...
		<table class="table table-border table-bordered table-bg table-hover table-sort">
			...
			<tbody id="articles">
				<tr class="text-c" v-for="item in list">
					...
					<td class="td-status">{{item.updated | time}}</td>
...
<script type="text/javascript">
    ...
    function onloads(value) {
        $.get("/item/list?page="+value, function (res) {
