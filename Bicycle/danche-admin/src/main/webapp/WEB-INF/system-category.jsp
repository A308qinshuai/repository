...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
		<a class="btn btn-primary radius" onclick="system_category_add('Android更新','system-category-add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>Android更新</a>
		<a class="btn btn-primary radius" onclick="system_category_add('iOS更新','system-ios-add.html')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i>iOS更新</a>
		</span>
